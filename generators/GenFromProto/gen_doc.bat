...
%2 model vsharpstudio %1vSharpStudio.vm\ViewModels\Generated\ProtoViewModels.cs Proto.Config %1doc\
echo **** interface vsharpstudio
%2 interface vsharpstudio %1vSharpStudio.common\ModelInterfaces.cs Proto.Config %1doc\

echo **** model conn_mssql
%2 model conn_mssql %1dbmodels\DbModel.MsSql\SettingsViewModels.cs Proto.Config.Connection %1doc\
echo **** interface conn_mssql
%2 interface conn_mssql %1dbmodels\DbModel.MsSql\SettingsInterfaces.cs Proto.Config.Connection %1doc\
