...
namespace vSharpStudio.wpf.Controls
{
    ...
    // https://docs.microsoft.com/en-us/dotnet/framework/wpf/controls/how-to-create-listviewitems-with-a-checkbox?view=netframework-4.8
    public class TreeList : ListView
    {
        ...
        public TreeList()
        {
            ...
            this._root = new TreeNode(this, null)
            {
                IsExpanded = true
            };
        ...
        private IEnumerable GetChildren(TreeNode parent)
        {
            ...
            if (parent == this.Root)
                ...
                return (parent.Tag as ITreeModel).GetChildren(parent.Tag);
            else
                return null;
        }
        private bool HasChildren(TreeNode parent)
        {
            if (parent == this.Root)
                return true;
            else if (parent.Tag != null && parent.Tag is ITreeModel)
