...
// https://github.com/dotnet/runtime/blob/main/src/libraries/Microsoft.Extensions.Logging.Abstractions/src/LoggerMessage.cs
...
namespace ApplicationLogging
{
    ...
    public static class LoggerMessage
    {
        ...
        private static LogValuesFormatter CreateLogValuesFormatter(string formatString, int expectedNamedParameterCount)
        {
            ...
            {
                ThrowHelper.ThrowArgumentException($"Format string '{formatString}'. Expected amount parameters {expectedNamedParameterCount}, but actual amount is {actualCount}.");
            }
