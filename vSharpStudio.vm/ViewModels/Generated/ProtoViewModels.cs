// Auto generated on UTC 12/08/2019 20:20:39
using System;
using System.Linq;
using ViewModelBase;
...
namespace vSharpStudio.vm.ViewModels // NameSpace.tt Line: 22
{
    ...
    public partial class GroupListPlugins : ConfigObjectBase<GroupListPlugins, GroupListPlugins.GroupListPluginsValidator>, IComparable<GroupListPlugins>, IConfigAcceptVisitor, IGroupListPlugins // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_group_list_plugins ConvertToProto(GroupListPlugins vm) // Clone.tt Line: 228
        {
            ...
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
    ...
    public partial class Plugin : ConfigObjectBase<Plugin, Plugin.PluginValidator>, IComparable<Plugin>, IConfigAcceptVisitor, IPlugin // Class.tt Line: 6
    {
        ...
        public static Plugin ConvertToVM(Proto.Config.proto_plugin m, Plugin vm) // Clone.tt Line: 163
        {
            ...
            vm.GroupGuid = m.GroupGuid; // Clone.tt Line: 218
            vm.GroupVersion = m.GroupVersion; // Clone.tt Line: 218
            vm.GroupInfo = m.GroupInfo; // Clone.tt Line: 218
            vm.OnInitFromDto(); // Clone.tt Line: 223
            return vm;
        }
        ...
        public static Proto.Config.proto_plugin ConvertToProto(Plugin vm) // Clone.tt Line: 228
        {
            ...
            m.Guid = vm.Guid; // Clone.tt Line: 254
            m.Version = vm.Version; // Clone.tt Line: 254
            m.Name = vm.Name; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
            ...
            m.GroupGuid = vm.GroupGuid; // Clone.tt Line: 254
            m.GroupVersion = vm.GroupVersion; // Clone.tt Line: 254
            m.GroupInfo = vm.GroupInfo; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class PluginGeneratorSettings : ConfigObjectBase<PluginGeneratorSettings, PluginGeneratorSettings.PluginGeneratorSettingsValidator>, IComparable<PluginGeneratorSettings>, IConfigAcceptVisitor, IPluginGeneratorSettings // Class.tt Line: 6
    {
        ...
        public static PluginGeneratorSettings ConvertToVM(Proto.Config.proto_plugin_generator_settings m, PluginGeneratorSettings vm) // Clone.tt Line: 163
        {
            ...
            vm.IsPrivate = m.IsPrivate; // Clone.tt Line: 218
            vm.FilePath = m.FilePath; // Clone.tt Line: 218
            vm.OnInitFromDto(); // Clone.tt Line: 223
            return vm;
        }
        ...
        public static Proto.Config.proto_plugin_generator_settings ConvertToProto(PluginGeneratorSettings vm) // Clone.tt Line: 228
        {
            ...
            m.Description = vm.Description; // Clone.tt Line: 254
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
            m.GeneratorSettings = vm.GeneratorSettings; // Clone.tt Line: 254
            m.IsPrivate = vm.IsPrivate; // Clone.tt Line: 254
            m.FilePath = vm.FilePath; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class SettingsConfig : ConfigObjectBase<SettingsConfig, SettingsConfig.SettingsConfigValidator>, IComparable<SettingsConfig>, IConfigAcceptVisitor, ISettingsConfig // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_settings_config ConvertToProto(SettingsConfig vm) // Clone.tt Line: 228
        {
            ...
            m.Guid = vm.Guid; // Clone.tt Line: 254
            m.Name = vm.Name; // Clone.tt Line: 254
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.VersionMigrationCurrent = vm.VersionMigrationCurrent; // Clone.tt Line: 254
            m.VersionMigrationSupportFromMin = vm.VersionMigrationSupportFromMin; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class DbSettings : ViewModelValidatableWithSeverity<DbSettings, DbSettings.DbSettingsValidator>, IDbSettings // Class.tt Line: 6
    {
        ...
        public static DbSettings ConvertToVM(Proto.Config.db_settings m, DbSettings vm) // Clone.tt Line: 163
        {
            ...
            vm.IdGenerator = (DbIdGeneratorMethod)m.IdGenerator; // Clone.tt Line: 216
            vm.PKeyType = (EnumPrimaryKeyType)m.PKeyType; // Clone.tt Line: 216
        ...
        public static Proto.Config.db_settings ConvertToProto(DbSettings vm) // Clone.tt Line: 228
        {
            ...
            m.DbSchema = vm.DbSchema; // Clone.tt Line: 254
            m.IdGenerator = (Proto.Config.db_id_generator_method)vm.IdGenerator; // Clone.tt Line: 252
            m.PKeyType = (Proto.Config.proto_enum_primary_key_type)vm.PKeyType; // Clone.tt Line: 252
            m.KeyName = vm.KeyName; // Clone.tt Line: 254
            m.Timestamp = vm.Timestamp; // Clone.tt Line: 254
            m.IsDbFromConnectionString = vm.IsDbFromConnectionString; // Clone.tt Line: 254
            m.ConnectionStringName = vm.ConnectionStringName; // Clone.tt Line: 254
            m.PathToProjectWithConnectionString = vm.PathToProjectWithConnectionString; // Clone.tt Line: 254
            return m;
        }
        #endregion Procedures
        #region Properties
    ...
    public partial class ConfigShortHistory : ConfigObjectBase<ConfigShortHistory, ConfigShortHistory.ConfigShortHistoryValidator>, IComparable<ConfigShortHistory>, IConfigAcceptVisitor, IConfigShortHistory // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_config_short_history ConvertToProto(ConfigShortHistory vm) // Clone.tt Line: 228
        {
            ...
            m.CurrentConfig = Config.ConvertToProto(vm.CurrentConfig); // Clone.tt Line: 248
            m.PrevStableConfig = Config.ConvertToProto(vm.PrevStableConfig); // Clone.tt Line: 248
            m.OldStableConfig = Config.ConvertToProto(vm.OldStableConfig); // Clone.tt Line: 248
            return m;
        }
    ...
    public partial class BaseConfigLink : ConfigObjectBase<BaseConfigLink, BaseConfigLink.BaseConfigLinkValidator>, IComparable<BaseConfigLink>, IConfigAcceptVisitor, IBaseConfigLink // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_base_config_link ConvertToProto(BaseConfigLink vm) // Clone.tt Line: 228
        {
            ...
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.Config = Config.ConvertToProto(vm.Config); // Clone.tt Line: 248
            m.RelativeConfigFilePath = vm.RelativeConfigFilePath; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class Config : ConfigObjectBase<Config, Config.ConfigValidator>, IComparable<Config>, IConfigAcceptVisitor, IConfig // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_config ConvertToProto(Config vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.LastUpdated = vm.LastUpdated; // Clone.tt Line: 254
            m.DbSettings = DbSettings.ConvertToProto(vm.DbSettings); // Clone.tt Line: 248
            m.GroupConfigLinks = GroupListBaseConfigLinks.ConvertToProto(vm.GroupConfigLinks); // Clone.tt Line: 248
            m.Model = ConfigModel.ConvertToProto(vm.Model); // Clone.tt Line: 248
            m.GroupPlugins = GroupListPlugins.ConvertToProto(vm.GroupPlugins); // Clone.tt Line: 248
            m.GroupAppSolutions = GroupListAppSolutions.ConvertToProto(vm.GroupAppSolutions); // Clone.tt Line: 248
            return m;
        }
    ...
    public partial class AppDbSettings : ViewModelValidatableWithSeverity<AppDbSettings, AppDbSettings.AppDbSettingsValidator>, IAppDbSettings // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_app_db_settings ConvertToProto(AppDbSettings vm) // Clone.tt Line: 228
        {
            ...
            m.PluginGuid = vm.PluginGuid; // Clone.tt Line: 254
            m.PluginName = vm.PluginName; // Clone.tt Line: 254
            m.Version = vm.Version; // Clone.tt Line: 254
            m.PluginGenGuid = vm.PluginGenGuid; // Clone.tt Line: 254
            m.PluginGenName = vm.PluginGenName; // Clone.tt Line: 254
            m.ConnGuid = vm.ConnGuid; // Clone.tt Line: 254
            m.ConnName = vm.ConnName; // Clone.tt Line: 254
            return m;
        }
        #endregion Procedures
        #region Properties
    ...
    public partial class GroupListAppSolutions : ConfigObjectBase<GroupListAppSolutions, GroupListAppSolutions.GroupListAppSolutionsValidator>, IComparable<GroupListAppSolutions>, IConfigAcceptVisitor, IGroupListAppSolutions // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_group_list_app_solutions ConvertToProto(GroupListAppSolutions vm) // Clone.tt Line: 228
        {
            ...
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.DefaultDb = AppDbSettings.ConvertToProto(vm.DefaultDb); // Clone.tt Line: 248
    ...
    public partial class PluginsGroup : ConfigObjectBase<PluginsGroup, PluginsGroup.PluginsGroupValidator>, IComparable<PluginsGroup>, IConfigAcceptVisitor, IPluginsGroup // Class.tt Line: 6
    {
        public partial class PluginsGroupValidator : ValidatorBase<PluginsGroup, PluginsGroupValidator> { } // Class.tt Line: 8
        #region CTOR
        public PluginsGroup(ITreeConfigNode parent) 
            : base(parent, PluginsGroupValidator.Validator) // Class.tt Line: 12
        {
            this.OnInitBegin();
            this.OnInit();
        }
        ...
        public static PluginsGroup Clone(ITreeConfigNode parent, PluginsGroup from, bool isDeep = true, bool isNewGuid = false) // Clone.tt Line: 27
        {
            PluginsGroup vm = new PluginsGroup(parent);
            vm.PluginsGroupGuid = from.PluginsGroupGuid; // Clone.tt Line: 62
            vm.PluginsGroupInfo = from.PluginsGroupInfo; // Clone.tt Line: 62
            vm.PluginsGlobalSettins = from.PluginsGlobalSettins; // Clone.tt Line: 62
            if (isNewGuid) // Clone.tt Line: 67
                vm.SetNewGuid();
            return vm;
        }
        public static void Update(PluginsGroup to, PluginsGroup from, bool isDeep = true) // Clone.tt Line: 72
        {
            to.PluginsGroupGuid = from.PluginsGroupGuid; // Clone.tt Line: 134
            to.PluginsGroupInfo = from.PluginsGroupInfo; // Clone.tt Line: 134
            to.PluginsGlobalSettins = from.PluginsGlobalSettins; // Clone.tt Line: 134
        }
        // Clone.tt Line: 140
        #region IEditable
        public override PluginsGroup Backup()
        {
            bool isDeep = true;
            this.OnBackupObjectStarting(ref isDeep);
            return PluginsGroup.Clone(this.Parent, this);
        }
        partial void OnBackupObjectStarting(ref bool isDeep);
        public override void Restore(PluginsGroup from)
        {
            bool isDeep = true;
            this.OnRestoreObjectStarting(ref isDeep);
            PluginsGroup.Update(this, from, isDeep);
        }
        partial void OnRestoreObjectStarting(ref bool isDeep);
        #endregion IEditable
        // Conversion from 'proto_plugins_group' to 'PluginsGroup'
        public static PluginsGroup ConvertToVM(Proto.Config.proto_plugins_group m, PluginsGroup vm) // Clone.tt Line: 163
        {
            if (m == null)
            {
                return vm;
            }
            vm.PluginsGroupGuid = m.PluginsGroupGuid; // Clone.tt Line: 218
            vm.PluginsGroupInfo = m.PluginsGroupInfo; // Clone.tt Line: 218
            vm.PluginsGlobalSettins = m.PluginsGlobalSettins; // Clone.tt Line: 218
            vm.OnInitFromDto(); // Clone.tt Line: 223
            return vm;
        }
        // Conversion from 'PluginsGroup' to 'proto_plugins_group'
        public static Proto.Config.proto_plugins_group ConvertToProto(PluginsGroup vm) // Clone.tt Line: 228
        {
            Proto.Config.proto_plugins_group m = new Proto.Config.proto_plugins_group(); // Clone.tt Line: 230
            m.PluginsGroupGuid = vm.PluginsGroupGuid; // Clone.tt Line: 254
            m.PluginsGroupInfo = vm.PluginsGroupInfo; // Clone.tt Line: 254
            m.PluginsGlobalSettins = vm.PluginsGlobalSettins; // Clone.tt Line: 254
            return m;
        }
        ...
        [PropertyOrderAttribute(1)]
        [DisplayName("Group")]
        [Description("Group compatible plugins of one vendor")]
        [Editor(typeof(EditorPluginsGroupSelection), typeof(EditorPluginsGroupSelection))]
        public string PluginsGroupGuid // Property.tt Line: 135
        { 
            get 
            { 
                return this._PluginsGroupGuid; 
            }
            set
            {
                if (this._PluginsGroupGuid != value)
                {
                    this.OnPluginsGroupGuidChanging(this._PluginsGroupGuid, value);
                    this._PluginsGroupGuid = value;
                    this.OnPluginsGroupGuidChanged();
                    this.NotifyPropertyChanged();
                    this.ValidateProperty();
                }
            }
        }
        private string _PluginsGroupGuid = string.Empty;
        partial void OnPluginsGroupGuidChanging(string from, string to); // Property.tt Line: 156
        partial void OnPluginsGroupGuidChanged();
        
        [PropertyOrderAttribute(2)]
        [DisplayName("Info")]
        [Description("Plugin short information")]
        [ReadOnly(true)]
        public string PluginsGroupInfo // Property.tt Line: 135
        { 
            get 
            { 
                return this._PluginsGroupInfo; 
            }
            set
            {
                if (this._PluginsGroupInfo != value)
                {
                    this.OnPluginsGroupInfoChanging(this._PluginsGroupInfo, value);
                    this._PluginsGroupInfo = value;
                    this.OnPluginsGroupInfoChanged();
                    this.NotifyPropertyChanged();
                    this.ValidateProperty();
                }
            }
        }
        private string _PluginsGroupInfo = string.Empty;
        partial void OnPluginsGroupInfoChanging(string from, string to); // Property.tt Line: 156
        partial void OnPluginsGroupInfoChanged();
        
        [PropertyOrderAttribute(3)]
        [DisplayName("Settings")]
        [Description("Global settings for plugin generators")]
        [ExpandableObjectAttribute()]
        public string PluginsGlobalSettins // Property.tt Line: 135
        { 
            get 
            { 
                return this._PluginsGlobalSettins; 
            }
            set
            {
                if (this._PluginsGlobalSettins != value)
                {
                    this.OnPluginsGlobalSettinsChanging(this._PluginsGlobalSettins, value);
                    this._PluginsGlobalSettins = value;
                    this.OnPluginsGlobalSettinsChanged();
                    this.NotifyPropertyChanged();
                    this.ValidateProperty();
                }
            }
        }
        private string _PluginsGlobalSettins = string.Empty;
        partial void OnPluginsGlobalSettinsChanging(string from, string to); // Property.tt Line: 156
        partial void OnPluginsGlobalSettinsChanged();
    ...
    public partial class AppSolution : ConfigObjectBase<AppSolution, AppSolution.AppSolutionValidator>, IComparable<AppSolution>, IConfigAcceptVisitor, IAppSolution // Class.tt Line: 6
    {
            ...
            : base(parent, AppSolutionValidator.Validator) // Class.tt Line: 12
        {
            ...
            this.PluginsGroup1 = new PluginsGroup(this); // Class.tt Line: 28
            this.PluginsGroup2 = new PluginsGroup(this); // Class.tt Line: 28
            this.PluginsGroup3 = new PluginsGroup(this); // Class.tt Line: 28
            this.OnInit();
        }
        partial void OnInitBegin();
        partial void OnInit();
        ...
        public static AppSolution Clone(ITreeConfigNode parent, AppSolution from, bool isDeep = true, bool isNewGuid = false) // Clone.tt Line: 27
        {
            ...
            if (isDeep) // Clone.tt Line: 59
                vm.PluginsGroup1 = PluginsGroup.Clone(vm, from.PluginsGroup1, isDeep);
            if (isDeep) // Clone.tt Line: 59
                vm.PluginsGroup2 = PluginsGroup.Clone(vm, from.PluginsGroup2, isDeep);
            if (isDeep) // Clone.tt Line: 59
                vm.PluginsGroup3 = PluginsGroup.Clone(vm, from.PluginsGroup3, isDeep);
            if (isNewGuid) // Clone.tt Line: 67
                vm.SetNewGuid();
            return vm;
        }
        public static void Update(AppSolution to, AppSolution from, bool isDeep = true) // Clone.tt Line: 72
        {
            ...
            if (isDeep) // Clone.tt Line: 131
                PluginsGroup.Update(to.PluginsGroup1, from.PluginsGroup1, isDeep);
            if (isDeep) // Clone.tt Line: 131
                PluginsGroup.Update(to.PluginsGroup2, from.PluginsGroup2, isDeep);
            if (isDeep) // Clone.tt Line: 131
                PluginsGroup.Update(to.PluginsGroup3, from.PluginsGroup3, isDeep);
        }
        // Clone.tt Line: 140
        #region IEditable
        ...
        public static AppSolution ConvertToVM(Proto.Config.proto_app_solution m, AppSolution vm) // Clone.tt Line: 163
        {
            ...
            if (vm.PluginsGroup1 == null) // Clone.tt Line: 206
                vm.PluginsGroup1 = new PluginsGroup(vm); // Clone.tt Line: 208
            PluginsGroup.ConvertToVM(m.PluginsGroup1, vm.PluginsGroup1); // Clone.tt Line: 212
            if (vm.PluginsGroup2 == null) // Clone.tt Line: 206
                vm.PluginsGroup2 = new PluginsGroup(vm); // Clone.tt Line: 208
            PluginsGroup.ConvertToVM(m.PluginsGroup2, vm.PluginsGroup2); // Clone.tt Line: 212
            if (vm.PluginsGroup3 == null) // Clone.tt Line: 206
                vm.PluginsGroup3 = new PluginsGroup(vm); // Clone.tt Line: 208
            PluginsGroup.ConvertToVM(m.PluginsGroup3, vm.PluginsGroup3); // Clone.tt Line: 212
            vm.OnInitFromDto(); // Clone.tt Line: 223
            return vm;
        }
        ...
        public static Proto.Config.proto_app_solution ConvertToProto(AppSolution vm) // Clone.tt Line: 228
        {
            ...
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.RelativeAppSolutionPath = vm.RelativeAppSolutionPath; // Clone.tt Line: 254
            m.DefaultDb = AppDbSettings.ConvertToProto(vm.DefaultDb); // Clone.tt Line: 248
            ...
            m.PluginsGroup1 = PluginsGroup.ConvertToProto(vm.PluginsGroup1); // Clone.tt Line: 248
            m.PluginsGroup2 = PluginsGroup.ConvertToProto(vm.PluginsGroup2); // Clone.tt Line: 248
            m.PluginsGroup3 = PluginsGroup.ConvertToProto(vm.PluginsGroup3); // Clone.tt Line: 248
            return m;
        }
        ...
        [Description("Group compatible plugins of one vendor")]
        [ExpandableObjectAttribute()]
        public PluginsGroup PluginsGroup1 // Property.tt Line: 109
        { 
            get 
            { 
                return this._PluginsGroup1; 
            }
            set
            {
                if (this._PluginsGroup1 != value)
                {
                    this.OnPluginsGroup1Changing(this._PluginsGroup1, value);
                    this._PluginsGroup1 = value;
                    this.OnPluginsGroup1Changed();
                    this.NotifyPropertyChanged();
                    this.ValidateProperty();
                }
            }
        }
        private PluginsGroup _PluginsGroup1;
        partial void OnPluginsGroup1Changing(PluginsGroup from, PluginsGroup to); // Property.tt Line: 130
        partial void OnPluginsGroup1Changed();
        [BrowsableAttribute(false)]
        public IPluginsGroup IPluginsGroup1 { get { return this._PluginsGroup1; } }
        
        [PropertyOrderAttribute(12)]
        [DisplayName("Group 2")]
        [Description("Group compatible plugins of one vendor")]
        [ExpandableObjectAttribute()]
        public PluginsGroup PluginsGroup2 // Property.tt Line: 109
        { 
            get 
            { 
                return this._PluginsGroup2; 
            }
            set
            {
                if (this._PluginsGroup2 != value)
                {
                    this.OnPluginsGroup2Changing(this._PluginsGroup2, value);
                    this._PluginsGroup2 = value;
                    this.OnPluginsGroup2Changed();
                    this.NotifyPropertyChanged();
                    this.ValidateProperty();
                }
            }
        }
        private PluginsGroup _PluginsGroup2;
        partial void OnPluginsGroup2Changing(PluginsGroup from, PluginsGroup to); // Property.tt Line: 130
        partial void OnPluginsGroup2Changed();
        [BrowsableAttribute(false)]
        public IPluginsGroup IPluginsGroup2 { get { return this._PluginsGroup2; } }
        
        [PropertyOrderAttribute(13)]
        [DisplayName("Group 3")]
        [Description("Group compatible plugins of one vendor")]
        [ExpandableObjectAttribute()]
        public PluginsGroup PluginsGroup3 // Property.tt Line: 109
        { 
            get 
            { 
                return this._PluginsGroup3; 
            }
            set
            {
                if (this._PluginsGroup3 != value)
                {
                    this.OnPluginsGroup3Changing(this._PluginsGroup3, value);
                    this._PluginsGroup3 = value;
                    this.OnPluginsGroup3Changed();
                    this.NotifyPropertyChanged();
                    this.ValidateProperty();
                }
            }
        }
        private PluginsGroup _PluginsGroup3;
        partial void OnPluginsGroup3Changing(PluginsGroup from, PluginsGroup to); // Property.tt Line: 130
        partial void OnPluginsGroup3Changed();
        [BrowsableAttribute(false)]
        public IPluginsGroup IPluginsGroup3 { get { return this._PluginsGroup3; } }
    ...
    public partial class AppProject : ConfigObjectBase<AppProject, AppProject.AppProjectValidator>, IComparable<AppProject>, IConfigAcceptVisitor, IAppProject // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_app_project ConvertToProto(AppProject vm) // Clone.tt Line: 228
        {
            ...
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.RelativeAppProjectPath = vm.RelativeAppProjectPath; // Clone.tt Line: 254
            m.DefaultDb = AppDbSettings.ConvertToProto(vm.DefaultDb); // Clone.tt Line: 248
    ...
    public partial class AppProjectGenerator : ConfigObjectBase<AppProjectGenerator, AppProjectGenerator.AppProjectGeneratorValidator>, IComparable<AppProjectGenerator>, IConfigAcceptVisitor, IAppProjectGenerator // Class.tt Line: 6
    {
        ...
        public static AppProjectGenerator Clone(ITreeConfigNode parent, AppProjectGenerator from, bool isDeep = true, bool isNewGuid = false) // Clone.tt Line: 27
        {
            ...
            vm.SortingValue = from.SortingValue; // Clone.tt Line: 62
            vm.Description = from.Description; // Clone.tt Line: 62
            vm.GroupPluginsGuid = from.GroupPluginsGuid; // Clone.tt Line: 62
            vm.PluginGuid = from.PluginGuid; // Clone.tt Line: 62
            vm.GeneratorSettings = from.GeneratorSettings; // Clone.tt Line: 62
        ...
        public static void Update(AppProjectGenerator to, AppProjectGenerator from, bool isDeep = true) // Clone.tt Line: 72
        {
            ...
            to.SortingValue = from.SortingValue; // Clone.tt Line: 134
            to.Description = from.Description; // Clone.tt Line: 134
            to.GroupPluginsGuid = from.GroupPluginsGuid; // Clone.tt Line: 134
            to.PluginGuid = from.PluginGuid; // Clone.tt Line: 134
            to.GeneratorSettings = from.GeneratorSettings; // Clone.tt Line: 134
        ...
        public static AppProjectGenerator ConvertToVM(Proto.Config.proto_app_project_generator m, AppProjectGenerator vm) // Clone.tt Line: 163
        {
            ...
            vm.SortingValue = m.SortingValue; // Clone.tt Line: 218
            vm.Description = m.Description; // Clone.tt Line: 218
            vm.GroupPluginsGuid = m.GroupPluginsGuid; // Clone.tt Line: 218
            vm.PluginGuid = m.PluginGuid; // Clone.tt Line: 218
            vm.GeneratorSettings = m.GeneratorSettings; // Clone.tt Line: 218
            vm.RelativePathToGeneratedFile = m.RelativePathToGeneratedFile; // Clone.tt Line: 218
            vm.OnInitFromDto(); // Clone.tt Line: 223
            return vm;
        }
        ...
        public static Proto.Config.proto_app_project_generator ConvertToProto(AppProjectGenerator vm) // Clone.tt Line: 228
        {
            ...
            m.SortingValue = vm.SortingValue; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.GroupPluginsGuid = vm.GroupPluginsGuid; // Clone.tt Line: 254
            m.PluginGuid = vm.PluginGuid; // Clone.tt Line: 254
            m.GeneratorSettings = vm.GeneratorSettings; // Clone.tt Line: 254
            m.RelativePathToGeneratedFile = vm.RelativePathToGeneratedFile; // Clone.tt Line: 254
            return m;
        }
        ...
        public string GroupPluginsGuid // Property.tt Line: 135
        { 
            get 
            { 
                return this._GroupPluginsGuid; 
            }
            set
            {
                if (this._GroupPluginsGuid != value)
                {
                    this.OnGroupPluginsGuidChanging(this._GroupPluginsGuid, value);
                    this._GroupPluginsGuid = value;
                    this.OnGroupPluginsGuidChanged();
                    this.NotifyPropertyChanged();
                    this.ValidateProperty();
                }
            }
        }
        private string _GroupPluginsGuid = string.Empty;
        partial void OnGroupPluginsGuidChanging(string from, string to); // Property.tt Line: 156
        partial void OnGroupPluginsGuidChanged();
    ...
    public partial class ConfigModel : ConfigObjectBase<ConfigModel, ConfigModel.ConfigModelValidator>, IComparable<ConfigModel>, IConfigAcceptVisitor, IConfigModel // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_config_model ConvertToProto(ConfigModel vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.GroupCommon = GroupListCommon.ConvertToProto(vm.GroupCommon); // Clone.tt Line: 248
            m.GroupConstants = GroupListConstants.ConvertToProto(vm.GroupConstants); // Clone.tt Line: 248
            m.GroupEnumerations = GroupListEnumerations.ConvertToProto(vm.GroupEnumerations); // Clone.tt Line: 248
            m.GroupCatalogs = GroupListCatalogs.ConvertToProto(vm.GroupCatalogs); // Clone.tt Line: 248
            m.GroupDocuments = GroupDocuments.ConvertToProto(vm.GroupDocuments); // Clone.tt Line: 248
            m.GroupJournals = GroupListJournals.ConvertToProto(vm.GroupJournals); // Clone.tt Line: 248
            return m;
        }
    ...
    public partial class DataType : ViewModelValidatableWithSeverity<DataType, DataType.DataTypeValidator>, IDataType // Class.tt Line: 6
    {
        ...
        public static DataType ConvertToVM(Proto.Config.proto_data_type m, DataType vm) // Clone.tt Line: 163
        {
            ...
            vm.DataTypeEnum = (EnumDataType)m.DataTypeEnum; // Clone.tt Line: 216
        ...
        public static Proto.Config.proto_data_type ConvertToProto(DataType vm) // Clone.tt Line: 228
        {
            ...
            m.DataTypeEnum = (Proto.Config.proto_enum_data_type)vm.DataTypeEnum; // Clone.tt Line: 252
            m.Length = vm.Length; // Clone.tt Line: 254
            m.Accuracy = vm.Accuracy; // Clone.tt Line: 254
            m.IsPositive = vm.IsPositive; // Clone.tt Line: 254
            m.ObjectGuid = vm.ObjectGuid; // Clone.tt Line: 254
            m.IsNullable = vm.IsNullable; // Clone.tt Line: 254
            foreach (var t in vm.ListObjectGuids) // Clone.tt Line: 233
                m.ListObjectGuids.Add(t); // Clone.tt Line: 235
            m.IsIndexFk = vm.IsIndexFk; // Clone.tt Line: 254
            return m;
        }
        #endregion Procedures
        #region Properties
    ...
    public partial class GroupListCommon : ConfigObjectBase<GroupListCommon, GroupListCommon.GroupListCommonValidator>, IComparable<GroupListCommon>, IConfigAcceptVisitor, IGroupListCommon // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_group_list_common ConvertToProto(GroupListCommon vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.GroupRoles = GroupListRoles.ConvertToProto(vm.GroupRoles); // Clone.tt Line: 248
            m.GroupViewForms = GroupListMainViewForms.ConvertToProto(vm.GroupViewForms); // Clone.tt Line: 248
            return m;
        }
    ...
    public partial class MainViewForm : ConfigObjectBase<MainViewForm, MainViewForm.MainViewFormValidator>, IComparable<MainViewForm>, IConfigAcceptVisitor, IMainViewForm // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_main_view_form ConvertToProto(MainViewForm vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.GroupListViewForms = GroupListMainViewForms.ConvertToProto(vm.GroupListViewForms); // Clone.tt Line: 248
            return m;
        }
    ...
    public partial class PropertiesTab : ConfigObjectBase<PropertiesTab, PropertiesTab.PropertiesTabValidator>, IComparable<PropertiesTab>, IConfigAcceptVisitor, IPropertiesTab // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_properties_tab ConvertToProto(PropertiesTab vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.GroupProperties = GroupListProperties.ConvertToProto(vm.GroupProperties); // Clone.tt Line: 248
            m.GroupPropertiesTabs = GroupListPropertiesTabs.ConvertToProto(vm.GroupPropertiesTabs); // Clone.tt Line: 248
            m.IsIndexFk = vm.IsIndexFk; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class GroupListProperties : ConfigObjectBase<GroupListProperties, GroupListProperties.GroupListPropertiesValidator>, IComparable<GroupListProperties>, IConfigAcceptVisitor, IGroupListProperties // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_group_list_properties ConvertToProto(GroupListProperties vm) // Clone.tt Line: 228
        {
            ...
            m.LastGenPosition = vm.LastGenPosition; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class Property : ConfigObjectBase<Property, Property.PropertyValidator>, IComparable<Property>, IConfigAcceptVisitor, IProperty // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_property ConvertToProto(Property vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.DataType = DataType.ConvertToProto(vm.DataType); // Clone.tt Line: 248
            m.Position = vm.Position; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class Enumeration : ConfigObjectBase<Enumeration, Enumeration.EnumerationValidator>, IComparable<Enumeration>, IConfigAcceptVisitor, IEnumeration // Class.tt Line: 6
    {
        ...
        public static Enumeration ConvertToVM(Proto.Config.proto_enumeration m, Enumeration vm) // Clone.tt Line: 163
        {
            ...
            vm.NameUi = m.NameUi; // Clone.tt Line: 218
            vm.Description = m.Description; // Clone.tt Line: 218
            vm.DataTypeEnum = (EnumEnumerationType)m.DataTypeEnum; // Clone.tt Line: 216
        ...
        public static Proto.Config.proto_enumeration ConvertToProto(Enumeration vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.DataTypeEnum = (Proto.Config.enum_enumeration_type)vm.DataTypeEnum; // Clone.tt Line: 252
            m.DataTypeLength = vm.DataTypeLength; // Clone.tt Line: 254
    ...
    public partial class EnumerationPair : ConfigObjectBase<EnumerationPair, EnumerationPair.EnumerationPairValidator>, IComparable<EnumerationPair>, IConfigAcceptVisitor, IEnumerationPair // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_enumeration_pair ConvertToProto(EnumerationPair vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.Value = vm.Value; // Clone.tt Line: 254
            return m;
        }
    ...
    public partial class Catalog : ConfigObjectBase<Catalog, Catalog.CatalogValidator>, IComparable<Catalog>, IConfigAcceptVisitor, ICatalog // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_catalog ConvertToProto(Catalog vm) // Clone.tt Line: 228
        {
            ...
            m.GroupProperties = GroupListProperties.ConvertToProto(vm.GroupProperties); // Clone.tt Line: 248
            m.GroupPropertiesTabs = GroupListPropertiesTabs.ConvertToProto(vm.GroupPropertiesTabs); // Clone.tt Line: 248
            m.GroupForms = GroupListForms.ConvertToProto(vm.GroupForms); // Clone.tt Line: 248
            m.GroupReports = GroupListReports.ConvertToProto(vm.GroupReports); // Clone.tt Line: 248
            return m;
        }
    ...
    public partial class GroupDocuments : ConfigObjectBase<GroupDocuments, GroupDocuments.GroupDocumentsValidator>, IComparable<GroupDocuments>, IConfigAcceptVisitor, IGroupDocuments // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_group_documents ConvertToProto(GroupDocuments vm) // Clone.tt Line: 228
        {
            ...
            m.NameUi = vm.NameUi; // Clone.tt Line: 254
            m.Description = vm.Description; // Clone.tt Line: 254
            m.GroupSharedProperties = GroupListProperties.ConvertToProto(vm.GroupSharedProperties); // Clone.tt Line: 248
            m.GroupListDocuments = GroupListDocuments.ConvertToProto(vm.GroupListDocuments); // Clone.tt Line: 248
            return m;
        }
    ...
    public partial class ModelRow : ViewModelBindable<ModelRow>, IModelRow // Class.tt Line: 6
    {
        ...
        public static Proto.Config.proto_model_row ConvertToProto(ModelRow vm) // Clone.tt Line: 228
        {
            ...
            m.GroupName = vm.GroupName; // Clone.tt Line: 254
            m.Name = vm.Name; // Clone.tt Line: 254
            m.Guid = vm.Guid; // Clone.tt Line: 254
            m.IsIncluded = vm.IsIncluded; // Clone.tt Line: 254
            return m;
        }
        #endregion Procedures
        #region Properties
    ...
    public interface IVisitorProto // IVisitorProto.tt Line: 7
    {
        ...
        void Visit(Proto.Config.proto_plugins_group p);
    ...
    public partial class ValidationConfigVisitor : ConfigVisitor // ValidationVisitor.tt Line: 7
    {
        ...
        protected override void OnVisit(PluginsGroup p) // ValidationVisitor.tt Line: 15
        {
            this.OnVisit(p as IValidatableWithSeverity);
        }
        protected override void OnVisitEnd(PluginsGroup p) // ValidationVisitor.tt Line: 47
        {
            this.OnVisitEnd(p as IValidatableWithSeverity);
        }
    ...
    public partial class ConfigVisitor : IVisitorConfigNode // NodeVisitor.tt Line: 7
    {
        ...
        public void Visit(PluginsGroup p)
        {
            this.OnVisit(p);
        }
        public void VisitEnd(PluginsGroup p)
        {
            this.OnVisitEnd(p);
        }
        protected virtual void OnVisit(PluginsGroup p) { }
        protected virtual void OnVisitEnd(PluginsGroup p) { }
    ...
    public interface IVisitorConfigNode // IVisitorConfigNode.tt Line: 7
    {
        ...
        void Visit(PluginsGroup p);
        void VisitEnd(PluginsGroup p);
