...
{
    public partial class Enumeration : EntityObjectBaseWithGuid<Enumeration, Enumeration.EnumerationValidator>, IConfigObject, ITreeNode, IComparable<Enumeration>
    {
        partial void OnInit()
        {
        }
