...
namespace vSharpStudio.vm.ViewModels
{
    ...
    public partial class GroupListBaseConfigLinks : ITreeModel, ICanAddSubNode, ICanGoRight
    {
        ...
        public override bool HasChildren(object parent) { return this.ListBaseConfigLinks.Count > 0; }
        ...
        public override ITreeConfigNode NodeAddNewSubNode(ITreeConfigNode node_impl = null)
        {
            ...
            this.Add(node);
            if (node_impl == null)
                GetUniqueName(BaseConfigLink.DefaultName, node, this.ListBaseConfigLinks);
            SetSelected(node);
            return node;
        }
