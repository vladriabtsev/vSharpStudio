...
namespace vSharpStudio.vm.ViewModels
{
    ...
    public partial class GroupListRegisters : ITreeModel, ICanAddSubNode, ICanGoRight, INodeGenSettings, IEditableNodeGroup
    {
        partial void OnDebugStringExtend(StringBuilder sb)
        {
            sb.Append(" Count:");
            sb.Append(this.ListRegisters.Count);
        }
        [Browsable(false)]
        ...
        partial void OnSortTypeChanged() { this.ListRegisters.Sort(this.SortType); }
        private void Init()
        {
            OnSortTypeChanged();
