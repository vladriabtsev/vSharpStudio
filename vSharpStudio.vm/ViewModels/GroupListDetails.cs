...
namespace vSharpStudio.vm.ViewModels
{
    ...
    public partial class GroupListDetails : ITreeModel, ICanAddSubNode, ICanGoRight, ICanGoLeft, INodeGenSettings, IEditableNodeGroup, IRoleAccess
    {
        ...
        partial void OnSortTypeChanged() { this.ListDetails.Sort((int)this.SortType); }
        private void Init()
        {
            OnSortTypeChanged();
        ...
        public override ITreeConfigNode NodeAddNewSubNode(ITreeConfigNode? node_impl = null)
        {
            ...
            if (this.ListDetails.Count > 0)
            {
                node.SortingValue = this.ListDetails[this.ListDetails.Count - 1].SortingValue + 1;
            }
            else
            {
                node.SortingValue = 1;
            ...
            node.ShortId = cfg.Model.LastTypeShortIdForNode();
