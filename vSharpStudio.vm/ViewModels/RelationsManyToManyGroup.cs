...
namespace vSharpStudio.vm.ViewModels
{
    ...
    public partial class RelationsManyToManyGroup : ITreeModel, ICanAddSubNode, ICanGoRight, INodeGenSettings, IEditableNodeGroup
    {
        ...
        public override ITreeConfigNode NodeAddNewSubNode(ITreeConfigNode? node_impl = null)
        {
            ...
            if (node_impl == null)
            {
                this.GetUniqueName(Defaults.RelationManyToManyName, node, this.ListRelations);
            }
        ...
        private void Init()
        {
            ...
            this._Name = Defaults.RelationsManyToManyGroupName;
        }
