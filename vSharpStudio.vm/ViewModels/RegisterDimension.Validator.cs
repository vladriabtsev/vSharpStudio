...
namespace vSharpStudio.vm.ViewModels
{
    public partial class RegisterDimensionValidator
    {
        public RegisterDimensionValidator()
        {
            ...
            this.RuleFor(x => x.CatalogGuid).NotEmpty().WithMessage("Catalog type is not selected for register dimension.");
            this.RuleFor(x => x.CatalogGuid).Custom((cguid, cntx) =>
            {
                ...
                {
                    var vf = new ValidationFailure(nameof(rd.CatalogGuid),
