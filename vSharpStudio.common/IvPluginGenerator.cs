...
namespace vSharpStudio.common
{
    public interface IvPluginGenerator
    {
        ...
        /// Useful if generator need special initialization when generator can be used more than once in the loop of code generation
        /// </summary>
        void Init();
        /// <summary>
        ...
        string Guid { get; }
        /// <summary>
        /// Unique identifier for group of generators. Generators will applied by groups
        /// </summary>
        //string GroupGeneratorsGuid { get; }
        /// <summary>
        /// Unique identifier solution parameters for group of generators. Generators will applied by groups
        /// </summary>
        string SolutionParametersGuid { get; }
        /// <summary>
        /// Unique identifier project parameters for group of generators. Generators will applied by groups
        /// </summary>
